(()=>{
const LANGS={en:'en-GB',ar:'ar-SA',yo:'yo-NG',ha:'ha-NG',ig:'ig-NG'};
const LABELS={
 ...
 ig:{listen:'🔊 Gee ntị',stop:'■ Kwụsị',today:'🔊 Gee ntị n’isiokwu akụkọ taa',unsupported:'Ihe nchọgharị a anaghị akwado ịgụ ihe n’olu.'}
};
let speakingButton=null;
function lang(){return (document.getElementById('langSelect')||{}).value||localStorage.getItem('al-bushra-lang')||'en'}
